...
.controller('RestaurantController', ['$scope','Restaurant','$routeParams','toaster','$q','$location','DishType', 'Upload', 'Aws', 'Dish', function($scope, Restaurant, $routeParams, toaster, $q, $location, DishType, Upload, Aws, Dish){
	$scope.restaurant = {};
